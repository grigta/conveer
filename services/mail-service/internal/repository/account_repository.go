...
func NewAccountRepository(db *mongo.Database, encryptor *crypto.Encryptor) *AccountRepository {
	return &AccountRepository{
		collection: db.Collection("mail_accounts"),
		encryptor:  encryptor,
	}
}

// Create creates a new account
func (r *AccountRepository) Create(ctx context.Context, account *models.MailAccount) error {
...
func (r *AccountRepository) GetByID(ctx context.Context, id primitive.ObjectID) (*models.MailAccount, error) {
...
func (r *AccountRepository) List(ctx context.Context, filter map[string]interface{}, limit, offset int) ([]*models.MailAccount, int64, error) {
	// Count total
